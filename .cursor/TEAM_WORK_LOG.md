...
- **Author:** team
- **Git:** not pushed
- **Summary:** Valid path QC ไม่กด Optimized/Verified · Invalid No Recheck QC ข้าม Review ทั้งหมด (ไม่กด Has Errors) · `runQcAllTasksRecovery` กดปุ่ม QC All Tasks บน Data Manager (idle 4s, cooldown 30s) · ext **1.8.13**
...
- **Author:** team
- **Git:** not pushed
- **Summary:** `waitForPostCancelSkipReady` + `hasAdequateExistingWaveformRegion`; ext 1.8.3
- **Files:** `content.js`, `manifest.json`, `learnings.md`
- **Tags:** cancel_skip, invalid, region
